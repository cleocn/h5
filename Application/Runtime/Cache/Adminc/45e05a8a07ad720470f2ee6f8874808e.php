       ...
       <form action="" method="post" class="form-horizontal">
            ...
            <table style="vertical-align: top;">
                <tr>
                    ...
                    <td>
                  <input name="site_name" type="text" value="<?php echo (C("site_name")); ?>" /><span>&nbsp;&nbsp;例：场景秀</span>
                    </td>
                </tr>
         <tr> 
      <td   align="right">网站地址：</td>
      <td><input type="text" name="site_url" value="<?php echo (C("site_url")); ?>" <span>&nbsp;&nbsp;例:http://bbs.cgtblog.com</span></td>
    </tr>  
                   <tr>
...
<span> 默认：#d0cfd8 </span></td>
     ...
     <tr> 
      ...
      <td><input type="text" name="lastpagetext" value="<?php echo (C("lastpagetext")); ?>" style="width:120px"/><span>&nbsp;&nbsp;例：场景秀</span> &nbsp;&nbsp;
...
<span> 默认：#23a3d3 </span></td>
     ...
     <tr> 
      ...
      <td><input type="text" name="lastpagelink" value="<?php echo (C("lastpagelink")); ?>"/><span>&nbsp;&nbsp;例：http://bbs.cgtblog.com</span></td>
    </tr>
