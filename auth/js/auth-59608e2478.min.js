...
angular.module("common.services.geetestService", []).factory("geetestService", ["$http", "$window", function(e, t) {
	...
	function l() {
		return t.initCaptcha = function() {
			r = new Geetest(s), r.appendTo("#captcha_box"), r.bindOn(".btn-geetest"), r.onSuccess(function() {
				o = r.getValidate()
			})
		},e.jsonp("https://api.geetest.com/get.php?callback=initCaptcha")
	}
	var o = null,
		r = null,
		s = {
			gt: "1ebc844c9e3a8c23e2ea4b567a8afd2d",
			//challenge: "ef2ab9e13d2669f708f6547a95ebe8024a",
			product: "popup",
			lang: "zh-cn"
		};
	return {
...
angular.module("common.services.utilService", []).factory("utilService", ["$window", function(e) {
	function s(s) {
		var t = JSON.stringify(s),
			...
			i = e.parent,
			n = e.opener;
			ao=i.document.getElementsByClassName("ngdialog ngdialog-theme-default ng-scope");
			ao[0].parentNode.removeChild(ao[0]);
